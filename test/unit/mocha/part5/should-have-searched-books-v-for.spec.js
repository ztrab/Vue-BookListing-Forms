...
describe("BookForm.vue", () => {
  it("should contain a 'book-item' element a v-for for searched-books @book-item-v-for-has-searched-books", () => {
    ...
    assert(
      bookItem.length === 2,
      "For this task, make sure that you're writing `<book-item v-for='book in searchedBooks' :key='book.id' :book='book'></book-item>` in one line as you see in this message."
    );
